...
public interface IRestHandler
{
    ...
    Task HandleDelete<TRequest>(Request<JsonNode> requestData, string[] pathParts, IHandler<TRequest> handler, Func<TRequest, Dictionary<string, string>, string[], (TRequest, IEnumerable<ValidationError>)> requestMerger, CancellationToken cancellationToken) where TRequest : new();
    ...
    Task HandlePost<TRequest>(Request<JsonNode> requestData, string[] pathParts, IHandler<TRequest> handler, Func<TRequest, Dictionary<string, string>, string[], (TRequest, IEnumerable<ValidationError>)> requestMerger, CancellationToken cancellationToken) where TRequest : new();
}